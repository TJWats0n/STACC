...
class Corpus:
    ...
    def discretize(self, time_slice_length):
        ...
        if os.path.exists('pyMABED/corpus'):
            shutil.rmtree('pyMABED/corpus')
        os.makedirs('pyMABED/corpus')
        ...
        for time_slice in range(self.time_slice_count):
            dummy_file = open('pyMABED/corpus/' + str(time_slice), 'w')
            dummy_file.write('')
        ...
        with open(self.source_file_path, 'r') as input_file:
            ...
            for line in csv_reader:
                ...
                with open('pyMABED/corpus/' + str(time_slice), 'a') as time_slice_file:
    ...
    def cooccurring_words(self, event, p):
        ...
        for i in range(event[1][0], event[1][1] + 1):
            with open('pyMABED/corpus/' + str(i), 'r') as input_file:
